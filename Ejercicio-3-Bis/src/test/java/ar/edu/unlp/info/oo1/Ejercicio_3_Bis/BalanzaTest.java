...
import ar.edu.unlp.info.oo1.Ejercicio_3_Bis.Balanza;
...
public class BalanzaTest {
  ...
  void testAgregarProducto() {
    ...
    assertEquals(230, balanza.getPrecioTotal());
  ...
  void testEmitirTicket() {
    ...
    assertEquals(230, ticket.getPrecioTotal());
    assertEquals(2, ticket.getCantidadDeProductos());
    assertEquals(230 * 0.21, ticket.impuesto());
